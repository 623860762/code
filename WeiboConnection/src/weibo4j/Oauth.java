...
public class Oauth extends Weibo{
	 ...
	 * 1.0版本移植接口
	 */
	public AccessToken getAccessTokenByPassword(String username,String password) throws WeiboException {
		return new AccessToken(client.post(
				WeiboConfig.getValue("accessTokenURL"),
				new PostParameter[] {
	...
	public JSONObject getTokenedUserInfo(String accessToken) throws WeiboException{
