...
public class Comments extends Weibo{
	...
	public CommentWapper getCommentToMe(Long since_id) throws WeiboException {
	       return Comment.constructWapperComments(client.get(
	...
	public CommentWapper getCommentMentions(Long since_id) throws WeiboException {
	       return Comment.constructWapperComments(
	           client.get(
