...
public class HttpClient implements java.io.Serializable {
		...
		try {
			...
			if (params != null) {
				...
				for (PostParameter entry : params) {
					System.out.println(entry.getName()+"\t"+(String) entry.getValue());
	...
	public Response multPartURL(String fileParamName, String url,
		...
		postMethod.addParameter("source", "185440769");
		postMethod.addParameter("tuid", "1437859313");
		postMethod.addParameter("gid", "");
		HttpMethodParams param = postMethod.getParams();
		param.setContentCharset("UTF-8");
		try {
			Part[] parts = null;
